...
- **Conversation-born terms don't ship.** A coined term may appear in spec text only after the spec states the rule it compresses, as a parenthetical mnemonic — a term may summarize an explanation, never replace one.
